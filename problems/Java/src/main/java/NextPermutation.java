 ...
 *     <p>Implement next permutation of an array of integers is the next lexicographically greater
 *     permutation of its integer. If such arrangement is not possible, the array must be rearranged
 *     as the lowest possible order.
 */
